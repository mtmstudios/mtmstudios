...
const content: Record<ServiceKey, Record<CityKey, RegionalContentData>> = {
  "ki-agentur": {
    stuttgart: {
      title: "KI-Agentur Stuttgart | Telefonassistent, Chatbot & Automatisierung | MTM Studios",
      description: "KI-Agentur Stuttgart: Telefonassistenten, Chatbots & Automatisierungen für den Stuttgarter Mittelstand. Kostenlose Erstberatung — in 48h einsatzbereit.",
