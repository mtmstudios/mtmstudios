  ...
  return (
    <section className="py-32 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          Manuelle Prozesse fressen Zeit, die besser in Wachstum und
          <br />
          Kundenerlebnis investiert wäre.
        </motion.p>
        ...
        >
          <CountUp target={73} /> aller Arbeitsschritte lassen sich automatisieren.
        </motion.p>
      </div>
    </section>
  );
...
export default AutomationsProblem;
